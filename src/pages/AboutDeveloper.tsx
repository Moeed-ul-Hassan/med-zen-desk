    ...
    <div className="max-w-2xl mx-auto py-8 sm:py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="bg-white rounded-lg shadow-md p-8">
        <p className="text-lg mb-4">
          Hi, I’m <span className="font-semibold">Moeed ul Hassan</span>, a full-stack developer specializing in{" "}
          <span className="font-semibold">React</span>,{" "}
          <span className="font-semibold">TypeScript</span>, and{" "}
          <span className="font-semibold">Python</span>. I build scalable web applications and tools with a focus on clean architecture, maintainable code, and real-world impact.
        </p>
        <p className="text-lg mb-4">
